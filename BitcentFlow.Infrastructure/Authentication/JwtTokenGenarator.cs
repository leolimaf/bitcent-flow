...
namespace BitcentFlow.Infrastructure.Authentication;
...
public class JwtTokenGenarator : IJwtTokenGenarator
{
    ...
    public ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
    {
        ...
        if (securityToken is not JwtSecurityToken jwtSecurityToken ||
            ...
            throw new BitcentFlowException(nameof(token), BitcentFlowExceptionType.UNAUTHORIZED, "Access Token inválido.");
